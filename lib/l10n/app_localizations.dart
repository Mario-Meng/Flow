...
class AppLocalizations {
  ...
  String get emptyStateSubtitle => isZh ? '点击下方按钮开始记录' : 'Tap button below to start';
  ...
  String get loadingLocation => isZh ? '正在获取附近地点...' : 'Loading nearby places...';
  String get locationPermissionNeeded => isZh ? '需要位置权限才能获取附近地点' : 'Location permission required';
  ...
  String get deleteConfirmMessage => isZh ? '确定要删除这条日记吗？' : 'Are you sure to delete this entry?';
  String get createTimeUpdated => isZh ? '创建时间已修改，保存后生效' : 'Create time modified, save to apply';
  String get createTimeCannotBeFuture => isZh ? '创建时间不能超过当前时间' : 'Create time cannot be in the future';
  String get validationMessage => isZh ? '请至少添加图片/视频、标题或内容' : 'Please add at least image/video, title or content';
